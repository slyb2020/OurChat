...
class SetupPropertyDialog(wx.Dialog):
    def __init__(self, parent, id=-1, title="参数设置窗口", size=wx.DefaultSize, pos=wx.DefaultPosition,
                 style=wx.DEFAULT_DIALOG_STYLE, name='Setup Property Dialog'):
        wx.Dialog.__init__(self)
        self.SetExtraStyle(wx.DIALOG_EX_METAL)
        self.Create(parent, id, title, pos, size, style, name)
        vbox = wx.BoxSizer(wx.VERTICAL)
        self.propertyPNL = TestPanel(self)
        vbox.Add(self.propertyPNL, 0, wx.EXPAND | wx.ALL, 5)
